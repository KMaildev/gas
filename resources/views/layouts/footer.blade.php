<footer id="site-footer" class="site-footer finance-footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-5 mb-xl-0">
                ...
                <div class="footer-contact">
                    ...
                    <div class="footer-contact-desc phone-info-desc">
                        <h6><a href="mailto:info@gas-mm.com">Mail Us</a></h6>
                        <p>info@gas-mm.com</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-5 mb-xl-0">
                ...
                <img src="{{ asset('data/map.png') }}" alt="">
            </div>
